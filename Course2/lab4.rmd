...
The press release for the poll, conducted by WIN-Gallup International, can be accessed [here](ushttps://www.scribd.com/document/136318147/Win-gallup-International-Global-Index-of-Religiosity-and-Atheism-2012).
...
Conditions: 
1) Random Sample and length(us12$response) = 1002 which is less than 10% of all US residents. Therefore, independence condition is met.
2) np = 1002*0.0499 = 50 which is greater than 10
n(1-p) = 952 which s greater than 10. 
Therefore, success-failure conditions hold true.

Since both conditions are true, distribution is going yo be nearly normal.


If the conditions for inference are reasonable, we can either calculate the standard error and construct the interval by hand, or allow the `inference` function to do it for us.

```{r us-atheism-ci}
inference(y = response, data = us12, statistic = "proportion", type = "ci", conf_level = 0.95, method = "theoretical", success = "atheist")
...
Answer: Margin of Error (ME) = z*sqrt((p(1-p))/n)
...
#Country1 = India
india12 = subset(atheism, atheism$nationality == "India" & atheism$year == "2012")
          by(india12$nationality, india12$response, length)
p <- sum(india12$response == 'atheist') / length(india12$response)
p

#Condition1: Random Sample and n = 1092 which is less than 10% of all Indian residents. Therefore, independence condition is met.
n <- length(india12$response)
n

#Condition2: Success-failure condition np = 33 which is greater than 10
#n(1-p) = 1059 which is greater than 10.
n*p
n*(1-p) 
...
#Inference
inference(y = response, data = india12, statistic = "proportion", type = "ci", conf_level = 0.95, method = "theoretical", success = "atheist")


#Country2 = Canada
canada12 = subset(atheism, atheism$nationality == "Canada" & atheism$year == "2012")
          by(canada12$nationality, canada12$response, length)
p <- sum(canada12$response == 'atheist') / length(canada12$response)
p

#Condition1: Random Sample and n = 1092 which is less than 10% of all Indian residents. Therefore, independence condition is met.
n <- length(canada12$response)
n

#Condition2: Success-failure condition np = 35.96407 which is greater than 10
#n(1-p) = 1056.036 which is greater than 10.
n*p
n*(1-p) 
...
#Inference
inference(y = response, data = canada12, statistic = "proportion", type = "ci", conf_level = 0.95, method = "theoretical", success = "atheist")
...
p = sum(spain$response == 'atheist')  / length(spain$response)
p

#Condition1: Random Sample and n = 2291 which is less than 10% of all Indian residents. Therefore, independence condition is met.
n <- length(spain$response)
n

#Condition2: Success-failure condition np = 218 which is greater than 10
#n(1-p) = 2073 which is greater than 10.
n*p
n*(1-p) 
...
inference(y = response, year , data = spain, statistic = "proportion", type = "ci", conf_level = 0.95, method = "theoretical", success = "atheist")
...
inference(y = response, year , data = us, statistic = "proportion", type = "ci", conf_level = 0.95, method = "theoretical", success = "atheist")
